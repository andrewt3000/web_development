...
- When the user login is successful (user submits valid username and password) the server signs and returns a jwt token to the client. User authorization claims such as user id or group id are encrypted in the token payload.   
